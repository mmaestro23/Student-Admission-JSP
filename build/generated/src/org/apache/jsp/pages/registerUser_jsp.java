...
public final class registerUser_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\n");
      out.write("\n");
      uni.beans.UserBean userBean = null;
      synchronized (request) {
        userBean = (uni.beans.UserBean) _jspx_page_context.getAttribute("userBean", PageContext.REQUEST_SCOPE);
        if (userBean == null){
          userBean = new uni.beans.UserBean();
